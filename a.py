"""
ProMatch Enterprise ATS - Professional Edition
...
# ==================== PAGE CONFIG ====================
st.set_page_config(
    page_title="ProMatch Enterprise ATS",
    page_icon="🎯",
    layout="wide",
...
with col1:
    st.markdown('<div class="main-header">⚡ ProMatch Enterprise ATS</div>', unsafe_allow_html=True)
...
if st.session_state.analysis_complete and st.session_state.results:
    ...
    with col3:
        ...
        summary_report = f"""
PROMATCH ENTERPRISE ATS - ANALYSIS REPORT
...
# ==================== WELCOME SCREEN ====================
    ...
    <div class="welcome-card">
        <h2 style="color: white; margin-bottom: 1rem;">👋 Welcome to ProMatch Enterprise ATS</h2>
...
<div style="text-align: center; color: #94a3b8; font-size: 0.85rem; padding: 1rem;">
    <strong>ProMatch Enterprise ATS</strong> v2.0 | 
